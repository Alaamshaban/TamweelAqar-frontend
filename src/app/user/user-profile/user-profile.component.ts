...
export class UserProfileComponent implements OnInit {
    ...
    patchForm(user) {
        this.userForm.patchValue({
            ...
            email_address:
                user.email_address === "null" ? "" : user.email_address,
            ...
            gender: user.gender,
            date_of_birth:
                user.date_of_birth === "null" ? null : user.date_of_birth,
    ...
    public compareWith(object1: any, object2: any) {
        ...
        return object1 && object2 && object1.nationality === object2.nationality;
    }
    ...
    updateUserEmailAndPass() {
        if (firebase.auth().currentUser) {
            firebase
                .auth()
                .currentUser.updateEmail(this.userForm.value.email_address)
                .then(
                    (result) => {
                        firebase
                            .auth()
